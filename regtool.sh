...
function usage {
    ...
    List all repos
        /$ $CMD https://registry.aguelsatria.web.id list

    List tags for one repo
        /$ $CMD https://registry.aguelsatria.web.id list some-repo

    Delete tag for a repo
        /$ $CMD https://registry.aguelsatria.web.id delete some-repo some-tag
